      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {cars.map((car) => (
            <div key={car.name} className="fleet-card">
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-4">{car.name}</h3>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border">
                  <div>
                    <span className="text-2xl font-bold text-primary">Rs {car.price.toLocaleString()}</span>
        ...
        <div className="text-center">
          <p className="text-muted-foreground mb-6">
            All the rates are just for Islamabad City. For out of city the rates are different.
          </p>
